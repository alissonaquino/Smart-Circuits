...
$sql = "SELECT * FROM quizz WHERE assunto_quizz LIKE '%$pesquisa%' ";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="text-center">Quizzes Registrados</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <form action="admBusQuizz.php" method="POST" >
      <div class="container">
      <div class="row ">
        <div class="col-10">
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
       <a href='excluirQuizz.php?id=$id' type='button' class='btn btn-danger'>Excluir</a>
      </div>
    </div>
  </div>
</div>
...
echo "<td>$tamanho perguntas</td>";
 ...
 if($media == 0){
    ...
    echo "
 <td>$dificuldade</td>
 <td ><a href='jogar.php?id=$id&i=1' class='btn btn-success btn-sm'>Ver</a></td>
 <td>
