...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="text-center">Discussões Denunciadas</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
...
if(isset($_POST['assunto'])){
  ...
  $query10 =  "SELECT * FROM moderacao WHERE id_dis != '0' ";
  $dados10 = mysqli_query($conn, $query10);
  while($linha10 = mysqli_fetch_assoc($dados10)){
    $idd = $linha10['id_dis'];
 
$query =  "SELECT * FROM discussao WHERE id_dis = '$idd' ";
...
<div class=''>
    ...
    <a href='excluirDenunciaDis.php?id=$id' class='btn btn-danger'>Excluir</a>
    <a href='aceitarDenunciaDis.php?id=$id' class='btn btn-success'>Permitir</a>
            </div>
