...
if(empty($resultado)){
    $result_usuario = "INSERT INTO gostar (id_dis, id_usu, gostar_gos, deslike_gos) VALUES ('$id', '$idusu', '0', '1')";
    ...
    while($linha = mysqli_fetch_assoc($result) ){
        $desgostar = $linha['deslike_gos']; 
    }
    if($desgostar == '0'){
    $query = "UPDATE gostar SET gostar_gos = '0', deslike_gos = '1' WHERE id_dis = '$id' && id_usu = '$idusu' ";
